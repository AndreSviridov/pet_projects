...
| 9.   | [DAU_WAU_MAU_Retention](https://github.com/AndreSviridov/pet_projects/blob/main/DAU_WAU_MAU_Retention/DAU_WAU_MAU_Retention.ipynb) | Расчет DAU, WA, MAU, Retention, Conversion: pandas, read_csv, timedelta, rolling, groupby, shift, sort_values, merge, loc. |
